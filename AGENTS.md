...
Each framework lives under `v1/`. When the upstream regulation changes materially, add `v2/` alongside rather than mutate `v1/` in place. See [COMPATIBILITY.md](docs/COMPATIBILITY.md).
