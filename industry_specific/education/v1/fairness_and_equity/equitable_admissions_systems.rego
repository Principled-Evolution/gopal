...
deny contains msg if {
	uses_prohibited_features(declarations.resolve(input, ["admissions_model", "features"]), prohibited_features)
	prohibited := {feature | some feature in declarations.resolve(input, ["admissions_model", "features"]); is_prohibited(feature, prohibited_features)}
